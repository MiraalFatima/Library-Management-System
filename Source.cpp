...
void graphics() {
	...
	gotoxy(24, 0);	cout << "                 888888888888888888888888888888888888888        " << endl;
	Sleep(40);
	gotoxy(24, 1);	cout << "                8    ------  -----  -----    |   /      8       " << endl;
	Sleep(40);
	gotoxy(24, 2);	cout << "               8    ||   |   |  |   |    |--/        8      " << endl;
	Sleep(40);
	gotoxy(24, 3);	cout << "              8     |_|    -----  -----    |  \\         8     " << endl;
	Sleep(40);
	gotoxy(24, 4);	cout << "             8                                   \\         8    " << endl;
	Sleep(40);
	gotoxy(24, 5);	cout << "            8                                               8   " << endl;
	Sleep(40);
	gotoxy(24, 6);	cout << "            88888888888888888888888888888888888888888888888888   " << endl;
	Sleep(40);
	...
	Sleep(40);
	gotoxy(25, 11);	cout << "           |||    ---  |     |  |_ ---   |     |        |||" << endl;
	Sleep(40);
	gotoxy(25, 12);	cout << "           |||                                            |||" << endl;
	Sleep(40);
	gotoxy(25, 13);	cout << "           |||              KUTAB   KHANA                 |||" << endl;
	Sleep(40);
	...
	Sleep(40);
	gotoxy(25, 18);	cout << "           |||             1:LOG-IN                       |||" << endl;
	Sleep(40);
	gotoxy(25, 19);	cout << "           |||             2:REGISTRATION                 |||" << endl;
	Sleep(40);
...
void Fine(int date1, int month1, int year1)
{
	...
	cout << "TYPE THE ORIGINAL RETURN DATE AGAIN " << endl;
	cout << "day: " << endl;
	cin >> day;
	cout << "month: " << endl;
	cin >> month;
